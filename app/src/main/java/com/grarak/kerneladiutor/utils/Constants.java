...
public interface Constants {
    ...
    String CPU_QUIET_ENABLE = CPU_QUIET + "/tegra_cpuquiet/enable";
    ...
    String GPU_CUR_2D_KOBO_TEGRA_FREQ = "/d/clock/c2bus/rate";
    String GPU_MAX_2D_KOBO_TEGRA_FREQ = "/sys/kernel/debug/clock/override.c2bus/rate";
    String GPU_AVAILABLE_2D_KOBO_TEGRA_FREQS = "/dev/c2bus_possible_rates";
    
    String GPU_CUR_3D_KOBO_TEGRA_FREQ = "/d/clock/c3bus/rate";
    String GPU_MAX_3D_KOBO_TEGRA_FREQ = "/sys/kernel/debug/clock/override.c3bus/rate";
    String GPU_AVAILABLE_3D_KOBO_TEGRA_FREQS = "/dev/c3bus_possible_rates";
    

    String[] GPU_2D_CUR_FREQ_ARRAY = {GPU_CUR_KGSL2D0_QCOM_FREQ, GPU_CUR_2D_KOBO_TEGRA_FREQ};

    String[] GPU_2D_MAX_FREQ_ARRAY = {GPU_MAX_KGSL2D0_QCOM_FREQ, GPU_MAX_2D_KOBO_TEGRA_FREQ};

    String[] GPU_2D_AVAILABLE_FREQS_ARRAY = {GPU_AVAILABLE_KGSL2D0_QCOM_FREQS, GPU_AVAILABLE_2D_KOBO_TEGRA_FREQS};
    ...
    String[] GPU_AVAILABLE_FREQS_ARRAY = {GPU_AVAILABLE_KGSL3D0_QCOM_FREQS, GPU_AVAILABLE_FDB00000_QCOM_FREQS,
            ...
            GPU_AVAILABLE_OMAP_FREQS, GPU_AVAILABLE_TEGRA_FREQS, GPU_AVAILABLE_3D_KOBO_TEGRA_FREQS};
